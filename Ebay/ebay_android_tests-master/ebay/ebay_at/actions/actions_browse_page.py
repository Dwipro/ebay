...
from ebay_at.mobile_functions.touch_actions import TouchAction
...
class BrowsePage(BasePage):
    ...
    def search_product_by_id(self, product_id):
        ...
        assert (BrowsePageElements(self.driver).product_id_string('//android.widget.TextView[@resource-id=\"'
        ...
        assert (
            BrowsePageElements(self.driver).product_name_string(
                '"//android.widget.TextView[@resource-id='com.ebay.mobile:id/search_box']")).is_displayed, \
